    ...
    <>
      ...
      <div className="absolute bottom-4 left-4 flex flex-col gap-1.5 pointer-events-none">
        {GROUP_ITEMS.map(({ key, label }) => (
          <div key={key} className="flex items-center gap-1.5 text-[12px]" style={{ color: 'var(--map-text-muted)' }}>
            <div
      ...
      <div className="absolute bottom-4 right-3 md:right-4 text-[12px] text-right pointer-events-none" style={{ color: 'var(--map-text-muted)' }}>
